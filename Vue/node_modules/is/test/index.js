...
test('is.instance', function (t) {
  t.ok(is.instance(new Date(), Date), 'new Data is instanceof Data');
  var F = function () {};
...
test('is.date', function (t) {
  t.ok(is.date(new Date()), 'new Data is date');
  ...
  t.notOk(is.date(new F()), 'Data subtype is not date');
  t.end();
});

test('is.date.valid', function (t) {
  t.ok(is.date.valid(new Date()), 'new Data() is a valid date');
  t.notOk(is.date.valid(new Date('')), 'new Data("") is not a valid date');
  t.end();
});
